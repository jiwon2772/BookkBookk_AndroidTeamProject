...
public class Main2Activity extends ActionBarActivity {
    ...
    private void setCustomActionbar()
    {
        ...
        peopleBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Main2Activity.this, FragmentsTab.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        });
        ...
        writeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Main2Activity.this, Writing.class );
        ...
        bookBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Main2Activity.this, BookShelfActivity.class);
                intent.putExtra("id",userId);
                startActivity(intent);
            }
        });
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapter, View view, int position,
            ...
            switch (position) {
                case 0:
                    final Intent intent = new Intent(Main2Activity.this, RequestList.class);
                    startActivity(intent);
                    break;
                case 1:
